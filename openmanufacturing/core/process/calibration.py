...
class CalibrationProfile:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "CalibrationProfile":
        ...
        """
        profile = cls()
        profile.coarse_movement_speed = data.get(
            "coarse_movement_speed", profile.coarse_movement_speed
        )
        ...
        profile.camera_pixels_per_um = data.get(
            "camera_pixels_per_um", profile.camera_pixels_per_um
        )
