...
class OpenAIClient:
    ...
    async def analyze_alignment_parameters(self, 
                                         device_type: str,
        ...
        try:
            ...
            response = await self.client.post(
                ...
                json={
                    "model": "gpt-4",
                    "messages": [
                        {"role": "system", "content": "You are an alignment parameter optimization assistant."},
            ...
            if json_matches:
                ...
                try:
                    ...
                    logger.info(f"Received suggested alignment parameters from AI")
    ...
    async def detect_alignment_anomalies(self, 
                                       device_type: str,
                                       current_result: Dict[str, Any],
                                       expected_ranges: Dict[str, Any]) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            response = await self.client.post(
                ...
                json={
                    "model": "gpt-4",
                    "messages": [
                        {"role": "system", "content": "You are an alignment anomaly detection assistant."},
                        {"role": "user", "content": prompt}
                    ],
                    "temperature": 0.3,
            ...
            try:
                ...
                logger.info(f"Received anomaly analysis from AI")
                return anomaly_data
    ...
    async def suggest_workflow_optimization(self,
        ...
        try:
            ...
            response = await self.client.post(
                ...
                json={
                    "model": "gpt-4",
                    "messages": [
                        {"role": "system", "content": "You are a manufacturing workflow optimization assistant."},
                        {"role": "user", "content": prompt}
                    ],
                    "temperature": 0.3,
                    "response_format": {"type": "json_object"}
            ...
            try:
                ...
                logger.info(f"Received workflow optimization suggestions from AI")
